...
- Name: sitemap-robots.spec.ts >> sitemap.xml >> includes /guides
- Location: tests\e2e\sitemap-robots.spec.ts:50:7

# Error details

```
Error: sitemap must include /guides

expect(received).toMatch(expected)

Expected pattern: /<loc>[^<]*\/guides<\/loc>/

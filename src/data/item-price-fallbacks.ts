...
export const ITEM_PRICE_FALLBACKS: Record<string, FallbackPrices> = {
  ...
  T7_MEAL_PIE: { sell: 15_200, buy: 18_500 },
  ...
  T6_POTION_HEAL: { sell: 3620, buy: 8080 },
  T6_POTION_ENERGY: { sell: 2800, buy: 6200 },
  T7_POTION_REVIVE: { sell: 4360, buy: 11_000 },
  ...
  T4_MILK: { sell: 95, buy: 120 },
  T4_BURDOCK: { sell: 240, buy: 280 },
  T5_EGG: { sell: 78, buy: 95 },
  T6_FOXGLOVE: { sell: 360, buy: 420 },
  T6_ALCOHOL: { sell: 320, buy: 380 },
  T6_MILK: { sell: 270, buy: 320 },
  T7_MULLEIN: { sell: 2000, buy: 2400 },
  T7_ALCOHOL: { sell: 1500, buy: 1800 },

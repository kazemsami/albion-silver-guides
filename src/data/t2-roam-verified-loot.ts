...
const verifiedSessionLoot: VerifiedLootLine[] = [
  // —— Filled mercenary journals ——
  { id: "T8_JOURNAL_MERCENARY_FULL", name: "Elder's Mercenary Journal (Full)", sessionQty: 1 },
  ...
  // —— Filled generalist trophy journals ——
  { id: "T6_JOURNAL_TROPHY_GENERAL_FULL", name: "Master's Generalist Trophy Journal (Full)", sessionQty: 3 },
  ...
  // —— Royal sigils ——
  { id: "QUESTITEM_TOKEN_ROYAL_T6", name: "Master's Royal Sigil", sessionQty: 22 },
  ...
  // —— Runes ——
  { id: "T8_RUNE", name: "Elder's Rune", sessionQty: 3 },
  ...
  // —— Souls ——
  { id: "T8_SOUL", name: "Elder's Soul", sessionQty: 1 },
  ...
  // —— Relics & fish ——
  { id: "T4_RELIC", name: "Adept's Relic", sessionQty: 200 },
  { id: "T5_FISH_FRESHWATER_ALL_COMMON", name: "River Sturgeon", sessionQty: 2 },

  // —— Luxury fishing treasures ——
  { id: "TREASURE_CEREMONIAL_RARITY3", name: "Golden Crown / Golden Harp", sessionQty: 4 },

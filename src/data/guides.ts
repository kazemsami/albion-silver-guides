...
const rawGuides: Omit<Guide, "reliability">[] = [
  ...
  },
  {
    ...
    description:
      "Roam lethal zones in a dirt-cheap T2 kit: fish schools between camps, fill fisher, mercenary, and trophy journals, grab luxury treasures, and gank when it is free. A fun low-risk roam idea — not a stable ~750k/hr baseline. The community 11.5M sample is a lucky multi-day haul, not typical hourly income.",
    category: "dungeons",
    difficulty: "intermediate",
    zoneType: "dangerous",
    silverPerHour: { min: 80_000, max: 400_000 },
    requirements: [
      "T2 Soldier plate + Fire Staff & Shield (~540 IP) plus T4 fishing rod and bait, deaths cost almost nothing",
      "Empty Adept Fisherman's Journal, Adept Mercenary's Journal, and a generalist trophy journal in your bag",
    ...
    steps: [
      ...
      "Clear open-world camps for silver bags, runes, souls, and relics. Camp mob kills fill your mercenary journal; chain camps when the zone is quiet and PvP is dry.",
    ...
    tips: [
      "Verified haul breakdown (~11.5M over ~10–15 hr): filled fisher, mercenary, and trophy journals, luxury fishing treasures, runes/souls/relics, mixed PvP gear, and tomes — not pure gank silver.",
      "Royal Sigils in that sample do not come from roaming; they are from Expeditions, Hardcore Expeditions, Crystal Arena, or crafting. The profit calculator excludes them.",
      "T2 roaming works because gear loss is cheap. Fish and fill journals during downtime; gank only when the fight is clearly yours.",
      "Mercenary journals fill from killing camp NPCs of their tier or higher, not from fishing. Carry one if you clear camps on your route.",
    ...
    profitBuild: {
      ...
      inventory: [
        ...
        },
        {
          ...
          hint: "Fills while killing camp NPCs",
        },
        {

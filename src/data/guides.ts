...
const rawGuides: Omit<Guide, "reliability" | "defaultMarketCity" | "riskProfile">[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "The calculator defaults to With focus and Sell normally. Material return is 45% on focus crafts and 15% without focus. Toggle Hold for events to model CTA or ZvZ price spikes.",

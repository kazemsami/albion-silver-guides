...
const rawGuides: Omit<Guide, "reliability">[] = [
  ...
  },
  {
    ...
    description:
      "Run The Depths from the Antiquarian's Den in 2-player mode (Orange PvP, gear stays equipped, bag loot drops on death). Clear level 2 in ~15 minutes with a Permafrost duo, cash out through exits or Soulgates, and bank ~750k-1M silver per extract for 3-4M/hr.",
    category: "dungeons",
    difficulty: "advanced",
    zoneType: "dangerous",
    silverPerHour: { min: 2_500_000, max: 4_500_000 },
    requirements: [
      "900+ base Item Power to enter (Inventory Details tab, food, mastery, and overcharge do not count toward the minimum)",
      "A partner queued in the same city, your group must enter from the same Antiquarian's Den",
      "5.1-6.1 budget kit under the 1200 IP softcap (20% scaling above cap)",
      "Empty bag before entry, only inventory items are lootable on death, not worn gear",
      "Mutton Stew or Beef Stew, Major Gigantify Potion, Major Healing Potion per run",
    ],
    steps: [
      "Meet your partner in an Antiquarian's Den (every royal city + Caerleon). Bank everything in the Den; it shares the city bank.",
      "Queue 2-player Duo mode together from the same city. Matchmaking runs in ~4-minute waves, everyone waiting at any royal-city Den enters one pool, so opponents may come from other cities.",
      "You are locked on each floor for a set period at the start. Clear every mob in each room to roll either a loot chest or a buff that lasts until you leave The Depths.",
      "Mobs and players drop Souls, white Neutral (mobs / forfeits), red Hostile (enemy players), blue Friendly (downed allies). Offer Hostile or Neutral Souls at the Altar of Greed (up to 3 per altar) for bonus loot, sacrificing a Hostile Soul there permanently removes that player from the run. Carry Friendly Souls to the Altar of Awakening to revive teammates (each altar works once per team).",
      "After the floor timer, exits appear, stairs up extract your loot; stairs down descend. Levels map to zone tiers: level 1 = T6, level 2 = T7, level 3 = T8. Level 2 is the best silver/hour baseline; only descend to level 3 for the Treasure Vault.",
      "On levels 1-2, extract via an upward floor exit or a Soulgate (sacrifice any Soul type, gate stays open 30 seconds). Level 3 has no upward exits, use Soulgates early or collect 3 Keys in Duo (5 in Trio), unlock the Treasure Vault, then leave through the 60-second channeled vault exit before collapse damage kills you.",
      "Bank loot in the Den and wait for the gateway re-entry cooldown (shown on the entrance UI) before the next wave. Target 3-4 full extracts per hour including matchmaking and run time.",
      "Sell tradable chest loot (runes, souls, resources) on Caerleon. Open silver bags immediately and loot player inventories you win in fights, both are untradable raw silver.",
    ],
    tips: [
      "The Depths use Orange PvP only, there is no separate lethal/non-lethal queue (that is Hellgates). Worn gear takes yellow-zone knockdown durability; inventory drops if you die in combat.",
      "IP rules: 900 minimum base IP, 1200 softcap with 20% scaling above it. A 5.1 Permafrost + Druid robe setup is the standard budget farm comp; 6.1 fits the cap for vault pushes.",
      "Solo queuing is allowed but room, altar, boss, and vault chests give ~25% less loot (Abyssal Depths Patch 5, Sept 2025). Always run with a partner for 3-4M/hr targets.",
      "Healing is reduced by 30% inside The Depths. Permafrost Prism clears rooms fast; a healer duo (e.g. Hallowfall) is more consistent when other teams contest level 2.",
      "Clear demonic statues for stacking Demonic Ferocity buffs (up to 15 stacks) and room buffs that trigger below 40% HP, both persist until you leave.",
      "Do not sit on loot through a collapse, escalating hellfire damage kills knocked players. Descend to an uncollapsed floor or extract early with profit.",
    ],
    profitBuild: {
      title: "Required Gear",
      description:
        "5.1 Permafrost Prism duo farm build under the 1200 IP softcap. Bag must be empty at entry.",
      slots: {
        head: {
        ...
        mainhand: {
          ...
          hint: "Standard Depths AoE clear",
        },
        cape: {
        ...
        food: {
          id: "T6_MEAL_STEW",
          name: "Mutton Stew",
          hint: "+damage without huge IP overcap",
        },
        potion: {
          id: "T6_POTION_HEAL",
          name: "Major Healing Potion",
          hint: "Remember -30% healing inside",
        },
      },
      inventory: [
        {
          ...
          hint: "Burst demons and PvP fights",
        },
      ],
    },
    featured: true,
  ...
  },
  {
    ...
    requirements: [
      ...
      "T6+ fishing rod recommended for Mist zones",
      "T3 Fancy Fish Bait at schools, faster bites mean more fish per hour",
    ...
    steps: [
      ...
      "Ride with Bloodletter, a cape, bag, and mount equipped, keep the rod in your bag and swap to it only when casting.",
      ...
      "Play the fishing minigame consistently; missed catches cut heavily into hourly profit.",
      "Bank fish before your Mist timer runs low or when your inventory is full.",
    ...
    tips: [
      ...
      "Never travel with the rod equipped, you want a weapon ready if a ganker dismounts you in the Mists.",
      "Watch the Mist exit timer, getting locked out with a full inventory wastes time.",
    ],
    profitBuild: {
      title: "Required Gear",
      description:
        "Fisherman armor for yield, but rod in bag while scouting: Bloodletter, cape, bag, and mount equipped by default.",
      slots: {
        head: {
          id: "T6_HEAD_GATHERER_FISH",
          name: "Master's Fisherman Cap",
          hint: "Use T7+ set at fishing level 60+",
        },
        armor: {
          id: "T6_ARMOR_GATHERER_FISH",
          name: "Master's Fisherman Garb",
          hint: "Fishing yield passive bonus",
        },
        shoes: {
          id: "T6_SHOES_GATHERER_FISH",
          name: "Master's Fisherman Workboots",
          hint: "Yield bonus + reduced fish weight",
        },
        mainhand: {
          id: "T4_MAIN_RAPIER_MORGANA",
          name: "Adept's Bloodletter",
        ...
        mount: {
          id: "T4_MOUNT_HORSE",
          name: "Adept's Riding Horse",
          hint: "Navigate Mist portals quickly",
        },
        food: {
          id: "T7_MEAL_PIE",
          name: "Pork Pie",
        ...
        potion: {
          id: "T8_POTION_CLEANSE",
          name: "Invisibility Potion",
          hint: "Escape if ambushed in the Mists",
        },
      },
      inventory: [
        {
          id: "T6_2H_TOOL_FISHINGROD",
          name: "Master's Fishing Rod",
          hint: "Equip at the school only: match rod tier to your level",
        },
        {
          id: "T3_FISHINGBAIT",
          name: "Fancy Fish Bait",

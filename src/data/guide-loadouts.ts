  ...
  "dungeon-maps-solo": {
    ...
    "t8-1": {
      ...
      slots: {
        ...
        mainhand: { id: "T8_2H_CROSSBOWLARGE", name: "Elder's Heavy Crossbow", hint: "AoE clearing" },
        ...
        potion: { id: "T6_POTION_HEAL@3", name: "Major Healing Potion .3", hint: "Emergency sustain" },
      },
    },
    "t8-3": {
